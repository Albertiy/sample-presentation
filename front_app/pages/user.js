            ...
            <div className={styles.form_container}>
                <div className={styles.form_row}>
                    <Box width="medium" direction="row" margin="medium" align="center" round="small" border>
                        <TextInput plain type={reveal ? 'text' : 'password'} value={value} onChange={event => setValue(event.target.value)} placeholder='旧密码' maxLength='20'
                        ></TextInput>
                ...
                <div className={styles.form_row}>
                    <Box width="medium" direction="row" margin="medium" align="center" round="small" border>
                        <TextInput plain type={oldReveal ? 'text' : 'password'} value={oldValue} onChange={event => setOldValue(event.target.value)} placeholder='新密码' maxLength='20'></TextInput>
